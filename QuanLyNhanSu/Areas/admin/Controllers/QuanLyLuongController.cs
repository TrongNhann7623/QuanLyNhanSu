    ...
    //     public class QuanLyLuongController : AuthorController
    {
        ...
        public ActionResult ThanhToanLuong()
        {
            ...
            foreach (var item in luong)
            {
                ...
                ct.BHTN = item.BHTN * (double)item.LuongToiThieu / 30;



                item.PhuCap = item.PhuCap == null ? 0 : item.PhuCap;
                item.PhuCap = item.LuongToiThieu * (double)item.PhuCap;
                ...
                ct.TienThuong = 0;
                ct.TienPhat = 0;
                tong = tong + ct.LuongCoBan - (double)(ct.BHXH + ct.BHYT)-(double)ct.BHTN - (double)ct.ThueThuNhap + (double)ct.PhuCap;
        ...
        public ActionResult ThanhToanMotNhanVien(String id)
        {
            ...
            if (nv != null)
            {
                ...
                ct.BHTN = luongthang.BHTN * (double)luongthang.LuongToiThieu /30;
        ...
        public ActionResult XuatFileLuong(String id)
        {
            ...
            dt.Columns.Add("Ngày nghỉ", typeof(String));
